...
CREATE TABLE Intervento( 
    ...
    CONSTRAINT CP_Intervento PRIMARY KEY (Tipo_Intervento, Data_Intervento)
);
...
CREATE TABLE Trattamento( 
    ...
    CONSTRAINT CP_Trattamento PRIMARY KEY (Nome_Trattamento, Data_Trattamento)
);

CREATE TABLE Tipo_Vino( 
    Nome_Vino varchar(255) NOT NULL, 
    Acidita int NOT NULL,  
    Colore varchar(255) NOT NULL, 
    Gradazione float NOT NULL, 
    Temp_Servizio float NOT NULL,
...
CREATE TABLE Cliente( 
	...
	Civico_Cl int NOT NULL,
	CAP_Cl int NOT NULL,
	Citta_Cl varchar(255) NOT NULL,
	Comune_Cl varchar(255) NOT NULL,
...
CREATE TABLE Ente_Certif( 
	...
	Civico_Ente int NOT NULL,
	CAP_Ente int NOT NULL,
...
CREATE TABLE Sede_Vinif(
    ...
    Temperatura_Fermentazione int NOT NULL,
    Num_fermentazioni_Subite int NOT NULL,

    CONSTRAINT CP_Sede_Vinif PRIMARY KEY (Via_Sv,Civico_Sv,CAP_Sv,Citta_Sv,Comune_Sv, Nome_Sede)
);
...
CONSTRAINT CE_Sede_Vinif_Mosto FOREIGN KEY (Via_Sv,Civico_Sv,CAP_Sv,Citta_Sv,Comune_Sv, Nome_Sede) REFERENCES Sede_Vinif (Via_Sv,Civico_Sv,CAP_Sv,Citta_Sv,Comune_Sv, Nome_Sede) ON DELETE CASCADE,  
...
CREATE TABLE Imbottigliatore(
    ...
    Civico_Imbott int NOT NULL, 
    CAP_Imbott int NOT NULL, 
    Citta_Imbott varchar(255) NOT NULL, 
    Comune_Imbott varchar(255) NOT NULL, 
Data_Imbott DATE NOT NULL,
Capacita_Bottiglia int  NOT NULL,
Metodo_Imbott varchar(255) NOT NULL,

    CONSTRAINT CP_Imbottigliatore PRIMARY KEY (Nome_Imbott, Via_Imbott, Civico_Imbott, Citta_Imbott, CAP_Imbott, Comune_Imbott)
);

CREATE TABLE Confezione( 
    Num_Conf int NOT NULL,
    Codice_Acquisto int NULL,
    Prezzo_Conf float NOT NULL, 
...
CREATE TABLE Interventi_Subiti(
    ...
    CONSTRAINT CE_Intervento_Interventi_Subiti FOREIGN KEY (Tipo_Intervento, Data_Intervento) REFERENCES Intervento (Tipo_Intervento, Data_Intervento) ON DELETE CASCADE
...
CREATE TABLE Trattamento_Subito(  
    ...
    Nome_Trattamento varchar(255) NOT NULL,  
    Data_Trattamento DATE NOT NULL,  
    Costo_Trattamento float NOT NULL,  
      
    CONSTRAINT CE_Vigneto_Trattamento_Subito FOREIGN KEY (NomeV, ComuneV) REFERENCES Vigneto (NomeV, ComuneV) ON DELETE CASCADE,  
    CONSTRAINT CE_Trattamento_Trattamento_Subito FOREIGN KEY (Nome_Trattamento, Data_Trattamento) REFERENCES Trattamento (Nome_Trattamento, Data_Trattamento) ON DELETE CASCADE
...
CREATE TABLE Cantina(
    ...
    Civico_Cantina int NOT NULL, 
    CAP_Cantina int NOT NULL, 
    Citta_Cantina varchar(255) NOT NULL, 
    Comune_Cantina varchar(255) NOT NULL,
    Nome_Sede varchar(255) NOT NULL,
    Num_Lotto int NOT NULL,
    Temperatura_Cantina int NOT NULL,
    Percentuale_Umidita int NOT NULL,
    Metratura_Cantina int NOT NULL,
...
CREATE TABLE Confezionamento(
    ...
    Num_Bottiglie_Confezionate int NOT NULL,
...
CREATE TABLE Vendita(
    ...
    Codice_Acquisto int NOT NULL,
    Metodo_Pagamento varchar(255) NOT NULL,
    Num_Confezioni_Vendute int NOT NULL,
